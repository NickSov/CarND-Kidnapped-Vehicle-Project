...
class ParticleFilter {
 public:
  ...
  /**
   * prediction Predicts the state of each particle for the next time step
   *   using the vehicle process model equations.
  ...
  VectorXd transformMarker(LandmarkObs obs, int indexParticle);
